...
class Periodic_Boundaries<Governing_Equation, FVM, Linear_Reconstruction<Gradient_Method>> : public Periodic_Boundaries_FVM_Linear_Base<Governing_Equation::space_dimension()>
{
private:
    static constexpr size_t space_dimension_ = Governing_Equation::space_dimension();
...
template <size_t space_dimension>
template<typename Numerical_Flux_Function, typename Residual, typename Solution>
void Periodic_Boundaries_FVM_Base<space_dimension>::calculate_RHS(std::vector<Residual>& RHS, const std::vector<Solution>& solutions) const {
