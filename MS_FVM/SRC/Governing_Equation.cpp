...
std::vector<Scalar_Conservation_Law_2D::Physical_Flux> Linear_Advection_2D::physical_fluxes(const std::vector<Solution>& solutions) {
...
std::vector<std::array<double, Linear_Advection_2D::physical_domain_dimension_>> Linear_Advection_2D::coordinate_projected_maximum_lambdas(const std::vector<Solution>& solutions) {
	static size_t num_solution = solutions.size();
...
double Linear_Advection_2D::inner_face_maximum_lambda(const Solution& solution_o, const Solution& solution_n, const Physical_Domain_Vector& nomal_vector) {
	return std::abs(nomal_vector.inner_product(advection_speeds_));
}

std::vector<Scalar_Conservation_Law_2D::Physical_Flux> Burgers_2D::physical_fluxes(const std::vector<Solution>& solutions) {
	static size_t num_solution = solutions.size();
...
std::vector<std::array<double, Burgers_2D::physical_domain_dimension_>> Burgers_2D::coordinate_projected_maximum_lambdas(const std::vector<Solution>& solutions) {
	static size_t num_solution = solutions.size();
...
double Burgers_2D::inner_face_maximum_lambda(const Solution& solution_o, const Solution& solution_n, const Physical_Domain_Vector& nomal_vector) {
