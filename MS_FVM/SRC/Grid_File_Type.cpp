...
size_t Gmsh::figure_type_index_to_figure_order(const size_t element_type_indx) {
...
Figure Gmsh::figure_type_index_to_element_figure(const size_t element_type_index) {
